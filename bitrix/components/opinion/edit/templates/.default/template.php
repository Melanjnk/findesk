<?
if ($arResult['OPINION'] instanceof Opinion) {
    $opinion = $arResult['OPINION'];
}
global $USER;
?>

<? if (!empty($arResult['EDIT'])) { ?>
...
<? } else { ?>
    <form action="" method="post" enctype="multipart/form-data" id="ADD_OPINION">
        ...
        <div class="add-opinion mb_16">
            ...
            <div class="fz_20 mb_20">Редактирование мнения (<?= $opinion->getId(); ?>)</div>
            ...
            <div class="add-opinion-table">
                    ...
                    <div class="add-opinion-table__overflow">
                        ...
                        <div class="selectbox width_280">
                            <select name="TYPE" class="select">
                                <option
                                    value="109" <?= (in_array('Бизнес', $opinion->getType())) ? "selected='selected'" : ""; ?>>
                                    Бизнес
                                </option>
                                <option
                                    value="110" <?= (in_array('Франшиза', $opinion->getType())) ? "selected='selected'" : ""; ?>>
                                    Франшиза
                                </option>
                            </select>
                        </div>
                ...
                <div class="add-opinion-table__row clear mb_24">
                    ...
                    <div class="add-opinion-table__overflow">
                        ...
                        <input type="text" name="SUB_NAME" class="input" value="<?= $opinion->getSubname(); ?>"/>
                ...
                <div class="add-opinion-table__row clear mb_24">
                    ...
                    <textarea class="textarea" name="QUOTE" cols="30" rows="10"
                              placeholder="Вырванный из текста кусочек, который призван удивить"><?= $opinion->getQuote(); ?></textarea>
                ...
                <div class="add-opinion-table__row clear mb_24">
                    ...
                    <div class="add-opinion-table__overflow">
                        ...
                        <div class="user-cover-edit-mode">
                            <div class="user-cover-edit-mode__in">
                                <img id="OPINION_PREVIEW_IMG" src="<?= $opinion->getPreviewPhoto(); ?>" alt="">
                            </div>
                        </div>
                ...
                <div class="add-opinion-table__row clear mb_24">
                    ...
                    <textarea name="PREVIEW_TEXT" cols="30" rows="10"
                              placeholder="Текст мнения"><?= $opinion->getPreviewText(); ?></textarea>
                ...
                <div class="add-opinion-table__row clear mb_24">
                    ...
                    <textarea name="DETAIL_TEXT" cols="30" rows="10"
                              placeholder="Текст мнения"><?= $opinion->getDetailText(); ?></textarea>
                ...
                <div class="add-opinion-table__row clear mb_24">
                    ...
                    <div class="add-opinion-table__overflow">
                        ...
                        <input type="text" name="HASH_TAGS" class="input" placeholder="Перечислите через запятую"
                               value="<?= $opinion->getHashTagString(); ?>"
                        />
        ...
        <div class="add-opinion-footer">
            ...
            <button type="submit" class="button button_lblue" name="EDIT_OPINION" value="1">ПРИМЕНИТЬ ИЗМЕНЕНИЯ
            </button>
        </div>
    </form>
